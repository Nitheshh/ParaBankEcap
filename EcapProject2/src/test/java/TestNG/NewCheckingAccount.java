...
public class NewCheckingAccount {
	...
	public void checkingAccount() {
		...
		WebElement newAccount = driver.findElement(By.linkText(prt.getProperty("NewAccountxpath")));
		newAccount.click();
		Select sct = new Select(driver.findElement(By.xpath(prt.getProperty("savingsxpath"))));
		sct.selectByIndex(0);
		WebElement submit = driver.findElement(By.xpath(prt.getProperty("OpenNewAccountButton")));
		submit.click();
	}
	@BeforeClass
